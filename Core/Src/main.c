...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_14|BLUELED_Pin|idac_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SS1_GPIO_Port, SS1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PD14 BLUELED_Pin idac_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_14|BLUELED_Pin|idac_Pin;
